...
<div class="wp-block-group" style="padding-top:var(--wp--preset--spacing--6)">
	...
	<p class="has-moss-color has-text-color has-label-font-size">Päevik</p>
	<!-- /wp:paragraph -->
	...
	<div class="wp-block-buttons">
		...
		<div class="wp-block-button is-style-outline"><a class="wp-block-button__link wp-element-button" href="/paevik/">Loe päevikut</a></div>
		<!-- /wp:button -->
	</div>
	<!-- /wp:buttons -->
